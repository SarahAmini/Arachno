...
public class countTimeLevel2 : MonoBehaviour {
	...
	void Start()
	{
		theOther = GameObject.FindGameObjectWithTag ("Spider2");
	...
	void Update()
	{
		if (!missionAccomplished) {
			if (GetComponent<Renderer> ().isVisible && theOther.GetComponent<Renderer>().isVisible) {
				brave = true;
